---
description: >-
  Complete reference for schedules, including queries, mutations, and types for
  defining recurring time patterns such as working hours and maintenance windows
...
**Implements:** [Node](../../core-api-reference/common.md#node), [Titled](../../core-api-reference/common.md#titled), [Versioned](../../core-api-reference/common.md#versioned)
...
| `workspace`    | [Workspace](workspaces/#workspace)!        | The workspace that owns this schedule.                                                                                                                                                                    |
| `scheduleData` | [ScheduleData](schedules.md#scheduledata)! | The calendar and time interval definitions for this schedule.                                                                                                                                             |
...
| Field       | Type                                                                 | Description                     |
| ----------- | -------------------------------------------------------------------- | ------------------------------- |
| `field`     | [ScheduleOrderField](schedules.md#scheduleorderfield)                | The standard field to order by. |
...
Schedule configuration as a JSON object — time intervals and recurrence. Backs the `Schedule` entity's `scheduleData`. Custom fields that need a schedule reference the entity instead.
