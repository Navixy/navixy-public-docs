...
This section contains detailed step-by-step tutorials for basic scenarios of using Business Data Repository (BDR), a product served by Navixy GraphQL API.
