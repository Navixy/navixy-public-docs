...
{% hint style="warning" %}
The API supports [GraphQL introspection](graphql-basics.md#introspection) for authenticated users. You can also check the public [GraphQL schema](https://raw.githubusercontent.com/Navixy/navixy-api/refs/heads/nvx4-clean/docs/navixy-repository-api/graphql-schema/schema.graphql).
{% endhint %}
