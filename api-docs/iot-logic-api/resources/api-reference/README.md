...
Under this section you can find a complete and interactive API reference generated from an up-to-date OpenAPI specification. There you can discover endpoint paths, parameters, object schemas (models), and test API calls right from the documentation. You can also download the raw OpenAPI specification as [JSON](https://raw.githubusercontent.com/Navixy/navixy-public-docs/refs/heads/main/api-docs/iot-logic-api/resources/api-reference/IoT_Logic.json).
...
<table><thead><tr><th width="229.72723388671875">Endpoint</th><th width="94.18182373046875">Method</th><th width="211.54541015625">Description</th><th>Key Parameters</th></tr></thead><tbody><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#post-iot-logic-flow-create">/iot/logic/flow/create</a></td><td>POST</td><td>Create a new flow</td><td><code>flow</code> object with title, nodes, edges</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-read">/iot/logic/flow/read</a></td><td>GET</td><td>Read an existing flow</td><td><code>flow_id</code></td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#post-iot-logic-flow-update">/iot/logic/flow/update</a></td><td>POST</td><td>Update an existing flow</td><td><code>flow</code> object with id, title, nodes, edges</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#post-iot-logic-flow-delete">/iot/logic/flow/delete</a></td><td>POST</td><td>Delete a flow</td><td><code>flow_id</code></td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-list">/iot/logic/flow/list</a></td><td>GET</td><td>List all flows</td><td>none</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-export">/iot/logic/flow/export</a></td><td>GET</td><td>Export an existing flow</td><td><code>flow_id</code></td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-sources-mapping-list">/iot/logic/flow/sources/mapping/list</a></td><td>GET</td><td>List all device-to-flow assignments</td><td>none</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-sources-list">/iot/logic/flow/sources/list</a></td><td>GET</td><td>List the device IDs feeding a specific flow</td><td><code>flow_id</code></td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#post-iot-logic-flow-sources-attribute-list">/iot/logic/flow/sources/attribute/list</a></td><td>POST</td><td>List telemetry attributes available for authoring expressions</td><td><code>source_ids</code> (optional)</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-template-list">/iot/logic/flow/template/list</a></td><td>GET</td><td>List all system-provided flow templates</td><td>none</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-template-read">/iot/logic/flow/template/read</a></td><td>GET</td><td>Retrieve a single system-provided flow template</td><td><code>flow_id</code> (template ID)</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#post-iot-logic-flow-push">/iot/logic/flow/push</a></td><td>POST</td><td>Send external data into a connector-configured Data Source node</td><td><code>flow_id</code>, <code>node_id</code>, plus the fields to merge</td></tr><tr><td><a href="https://www.navixy.com/docs/iot-logic-api/resources/api-reference/flow#get-iot-logic-flow-schema-read">/iot/logic/flow/schema/read</a></td><td>GET</td><td>Retrieve the JSON Schema definition for all node types</td><td>none</td></tr></tbody></table>

{% hint style="warning" %}
The schema returned by `/iot/logic/flow/schema/read` describes the Navixy UI form's validation rules, not a guaranteed write-API contract. `flowCreate` and `flowUpdate` don't enforce every constraint it lists. For example, a field marked required in the schema may be silently defaulted instead of rejected.
{% endhint %}
