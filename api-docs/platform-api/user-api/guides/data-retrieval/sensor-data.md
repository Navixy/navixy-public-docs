...
Some sensors are automatically created by the platform when a new device is activated. The list of such sensors depends on the model capabilities. These automatically created sensors provide immediate data without requiring additional setup.
...
* Input states: [get\_inputs](../../resources/tracking/tracker/#post-tracker-get_inputs)
* CAN and OBD sensor data: [get\_diagnostics](../../resources/tracking/tracker/#post-tracker-get_diagnostics)
* Fuel sensor data: [get\_fuel](../../resources/tracking/tracker/#post-tracker-get_fuel)
* Other metering sensor readings: [get\_readings](../../resources/tracking/tracker/#post-tracker-get_readings)

#### Comprehensive sensor data

To retrieve data from all sensors, states, and counters of a device, use the [tracker/readings/list](../../resources/tracking/tracker/readings.md#post-tracker-readings-list) API call.
...
To optimize requests for multiple devices, use the [tracker/readings/batch\_list](../../resources/tracking/tracker/readings.md#post-tracker-readings-batch_list) API call.

#### Historical sensor data

To retrieve historical data from measurement sensors (up to 30 days), use the [tracker/sensor/data/read](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-data-read) API call. Specify the sensor ID, which can be obtained using the [sensor/list](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-list) request.
...
To create a counter, use the [value/set](../../resources/tracking/tracker/counter.md#post-tracker-counter-value-set) API call.

Example for creating an odometer counter:

```shell
curl --request POST \
  --url 'https://api.eu.navixy.com/v2/tracker/counter/read' \
  --header 'Content-Type: application/json' \
  --data '{"hash": "22eac1c27af4be7b9d04da2ce1af111b", "tracker_id": 311852, "type": "odometer", "value": 98342.1}'
```
...
curl --request POST \
  --url 'https://api.eu.navixy.com/v2/tracker/counter/read' \
  --header 'Content-Type: application/json' \
  --data '{"hash": "22eac1c27af4be7b9d04da2ce1af111b", "tracker_id": 311852, "type": "engine_hours", "value": 2368.2}'
```

#### Retrieving counter values

* Get all counter values: [get\_counters](../../resources/tracking/tracker/counter.md#post-tracker-get_counters)
* Get specific counter type for one device: [value/get](../../resources/tracking/tracker/counter.md#post-tracker-counter-value-get)
* Get counter values for multiple devices: [value/list](../../resources/tracking/tracker/counter.md#post-tracker-counter-value-list)

#### Historical counter data

To retrieve counter values with timestamps for a specific period, use the [data/read](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-data-read) API call.
...
To utilize this data effectively, create a separate virtual sensor for each parameter you wish to monitor. By decoding the specific bits, you can track various states and conditions of a vehicle precisely.

### Managing virtual sensors

#### Creating a virtual sensor

To create a virtual sensor, use the [tracker/sensor/create](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-create) API call. This allows you to define and configure virtual sensors based on specific input parameters. Virtual sensors can be used to monitor various conditions and provide meaningful insights.

Example for creating a virtual ignition sensor:

```shell
curl --request POST \
  --url 'https://api.eu.navixy.com/v2/tracker/sensor/create' \
--header 'Content-Type: application/json' \
--data '{"hash": "22eac1c27af4be7b9d04da2ce1af111b", "tracker_id": 123456, "sensor": {"type": "virtual", "sensor_type": "virtual_ignition", "name": "Virtual Ignition", "input_name": "board_voltage", "parameters": {"calc_method": "in_range", "range_from": 13.4, "value_titles": [{"value": "0", "title": "Off"}, {"value": "1", "title": "On"}]}}}'
```
...
To update an existing virtual sensor, use the [tracker/sensor/update](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-update) API call. This is useful for modifying the parameters or configuration of an already created sensor to reflect new thresholds or settings.

Example for updating a virtual ignition sensor:

```shell
curl --request POST \
  --url 'https://api.eu.navixy.com/v2/tracker/sensor/update' \
  --header 'Content-Type: application/json' \
  --data '{"hash": "22eac1c27af4be7b9d04da2ce1af111b", "tracker_id": 123456, "sensor": {"type": "virtual", "sensor_id": 965837, "sensor_type": "virtual_ignition", "name": "Virtual Ignition", "input_name": "board_voltage", "parameters": {"calc_method": "in_range", "range_from": 13.7, "value_titles": [{"value": "0", "title": "Off"}, {"value": "1", "title": "On"}]}}}'
```
...
1.  **Historical data**\
    Use the [tracker/sensor/data/read](../../resources/tracking/tracker/sensor/README.md#post-tracker-sensor-data-read) API call.

    Example:

    ```shell
    curl --request POST \
      --url 'https://api.eu.navixy.com/v2/tracker/sensor/data/read' \
      --header 'Content-Type: application/json' \
      --data '{"hash": "22eac1c27af4be7b9d04da2ce1af111b", "tracker_id": 123456, "sensor_id": 965837, "from": "2023-07-24 00:00:00", "to": "2023-07-24 23:59:00", "raw_data": false}'
    ```
2.  **Current values**\
    Use the [tracker/readings/batch\_list](../../resources/tracking/tracker/readings.md#post-tracker-readings-batch_list) API call for multiple devices.

    Example:

    ```shell
    curl --request POST \
      --url 'https://api.eu.navixy.com/v2/tracker/readings/batch_list' \
      --header 'Content-Type: application/json' \
      --data '{"hash": "a6aa75587e5c59c32d347da438505fc3", "trackers": [10181215,10038816]}'
    ```
...
1.  **Equipment working time report**
    ...
    * Shows operational times of units linked to discrete or virtual inputs.
    ...
    ```shell
    curl --request POST \
      --url 'https://api.eu.navixy.com/v2/report/tracker/generate' \
      --header 'Content-Type: application/json' \
      --data '{"hash": "a6aa75587e5c59c32d347da438505fc3", "title": "Equipment working time", "trackers": [642546], "from": "2023-07-27 00:00:00", "to": "2023-07-27 23:59:59", "time_filter": {"from": "00:00:00", "to": "23:59:59", "weekdays": [1,2,3,4,5,6,7]}, "plugin": {"hide_empty_tabs":true,"plugin_id":12,"show_seconds":false,"min_working_period_duration":60,"show_idle_percent":true,"filter":false,"sensors":[{"tracker_id":642546,"sensor_id":1931610}]}}'
    ```
2.  **Engine hours report**
    ...
    * Shows working duration for ignition-based sensors.
    ...
    curl --request POST \
      --url 'https://api.eu.navixy.com/v2/report/tracker/generate' \
      --header 'Content-Type: application/json' \
      --data '{"hash": "a6aa75587e5c59c32d347da438505fc3", "title": "Engine hours report", "trackers": [642546], "from": "2023-07-27 00:00:00", "to": "2023-07-27 23:59:59", "time_filter": {"from": "00:00:00", "to": "23:59:59", "weekdays": [1,2,3,4,5,6,7]}, "plugin": {"hide_empty_tabs":true,"plugin_id":7,"show_seconds":false,"show_detailed":true,"include_summary_sheet":true,"include_summary_sheet_only":false,"filter":true}}'
    ```
...
4.  **Vehicle readings report**
    ...
    * Shows data from vehicle instruments via CAN/OBD or virtual sensors.
    ...
    curl --request POST \
      --url 'https://api.eu.navixy.com/v2/report/tracker/generate' \
      --header 'Content-Type: application/json' \
      --data '{"hash": "a6aa75587e5c59c32d347da438505fc3", "title": "Vehicle readings report", "trackers": [642546], "from": "2023-07-27 00:00:00", "to": "2023-07-27 23:59:59", "time_filter": {"from": "00:00:00", "to": "23:59:59", "weekdays": [1,2,3,4,5,6,7]}, "plugin": {"hide_empty_tabs": true, "plugin_id": 22, "details_interval_minutes": 5, "graph_type": "time", "smoothing": true, "show_address": false, "filter": true, "sensors": [{"tracker_id": 1685505, "sensor_id": 613753}]}}'
    ```
