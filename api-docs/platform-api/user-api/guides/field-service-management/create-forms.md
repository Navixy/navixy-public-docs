...
To enable employees to fill out forms and for users to assign these forms to tasks, form templates must be [created](../../resources/field-service/form/template.md#post-form-template-create). Let's create a form for a delivery service, where employees deliver products like trackers and provide additional services if needed. Detailed form field types can be found [here](../../resources/field-service/form/field-types.md).
...
```shell
curl --request POST \
  --url 'https://api.eu.navixy.com/v2/form/template/create' \
...
A form can be assigned to an existing task with the [task update](../../resources/field-service/task/#post-task-update) call or used during [task creation](../../resources/field-service/task/#post-task-create).
...
* Obtain a [list of templates](../../resources/field-service/form/template.md#post-form-template-list) to get the `template_id` of the desired form.
* Retrieve the [list of tasks](../../resources/field-service/task/form/README.md#post-task-form-list) with the specific `template_id` and time period.
* Use the `task_id` to [download](../../resources/field-service/task/form/README.md#post-task-form-download) or [read](../../resources/field-service/task/form/README.md#post-task-form-read) the form.

Alternatively:

* Get a [list of tasks](../../resources/field-service/task/#post-task-list) to find a specific task and obtain the `form_id`.
* Use the `form_id` to [read](../../resources/field-service/task/form/README.md#post-task-form-read) and [download](../../resources/field-service/task/form/README.md#post-task-form-download) the forms.

### Specific forms submitted with check-ins

* Obtain a list of [check-ins](../../resources/field-service/checkin.md#post-checkin-list) to get the `form_id`.
* Use the `form_id` to [read](../../resources/field-service/task/form/README.md#post-task-form-read) and [download](../../resources/field-service/task/form/README.md#post-task-form-download) the forms.
...
* [Generate](../../resources/commons/report/report_tracker.md#post-report-tracker-generate) a form completion report with [plugin\_id 70](../../resources/commons/plugin/report_plugins.md#form-completion-statistics-report).
* [Download](../../resources/commons/report/report_tracker.md#post-report-tracker-download) the report.
