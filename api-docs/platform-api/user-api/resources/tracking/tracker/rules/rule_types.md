---
title: Rule types
description: Every rule type a tracker can carry, with the parameters each one takes.
---

# Rule types

A [rule](rule.md) fires when its condition is met, and the condition is decided by the rule's `type`. This page catalogues every type, and for each one gives the parameters it accepts.

Which types are available to a given tracker is not fixed. It depends on the device model, on what equipment is connected and configured on it, and on whether the Navixy platform integrates that rule for that device. A type absent from a tracker's options is one its hardware cannot support.

Each entry below states the `type` value to send, the `param` and `extended_params` it takes, and the meaning of `primary_text` and `secondary_text` for that type.

### Geofence entrance or exit

A rule that triggers on device entering/exiting created on platform [geofences](../../zone/#post-zone-list).

#### Parameters

| name            | description                                                                    | type                            |
| --------------- | ------------------------------------------------------------------------------ | ------------------------------- |
| type            | `inoutzone` for this rule type.                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                   | type                            |
| --------------- | ----------------------------------------------------------------------------- | ------------------------------- |
| type            | `track_change` for this rule type.                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                   | type                            |
| ------------- | --------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `over_speed_reported` for this rule type.                                                     | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                               | type                            |
| ------------- | ------------------------------------------------------------------------- | ------------------------------- |
| type          | `speedup` for this rule type.                                             | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                 | type                            |
| ------------- | ------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `route` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                            | type                            |
| --------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type            | `excessive_driving` for this rule type.                                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                 | type                            |
| --------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `excessive_parking` for this rule type.                                                                     | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                 | type                            |
| ------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `task_status_change` for this rule type.                                                                    | [enum](../../../../../general/api-conventions.md#data-types) |
...
A rule that triggers when tracker [work status](../../status/tracker.md) changes. Choose specific status IDs from a currently assigned to tracker [status listing](../../status/listing/README.md).

#### Parameters

| name          | description                                                                                                    | type                            |
| ------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `work_status_change` for this rule type.                                                                       | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name                  | description                                                                                                                                  | type      |
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| `status_ids`           | List of tracked status IDs. Choose specific status IDs from a currently assigned to tracker [status listing](../../status/listing/README.md). | int array |
| emergency             | If `true` enables emergency notification.                                                                                                    | boolean   |
| `private_rule`         | Affects only sub users. If `true` then the rule and notifications are visible only to sub user.                                              | boolean   |
| `zone_limit_inverted` | The rule tracked inside of zones if `false` or outside if `true`. Default is: `false`.                                                       | boolean   |
| `append_zone_title`   | Show or not the zone labels in a notification text. Must be `null` or `false` if the `zone_limit_inverted` param set to `true`.              | boolean   |
...
| name            | description                                                               | type                            |
| --------------- | ------------------------------------------------------------------------- | ------------------------------- |
| type            | `idling` for this rule type.                                              | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                | type                            |
| --------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `idling_soft` for this rule type.                                                                          | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                   | type                            |
| --------------- | --------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `fuel_level_leap` for this rule type.                                                         | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                        | type                            |
| ------------- | -------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `harsh_driving` for this rule type.                                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                               | type                            |
| ------------- | ------------------------------------------------------------------------- | ------------------------------- |
| type          | `driver_assistance` for this rule type.                                   | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                                    | type                            |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type          | `auto_geofence` for this rule type.                                                                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                               | type                            |
| ------------- | ----------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `autocontrol` for this rule type.                                                         | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                      | type                            |
| ------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `crash_alarm` for this rule type.                                                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                          | type                            |
| --------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `cruise_control` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                    | type                            |
| --------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `distance_control` for this rule type.                                                         | [enum](../../../../../general/api-conventions.md#data-types) |
...
| `control_type`             | Type of distance control. One of `["moving_away", "approaching"]`.                                                              | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                 | type                            |
| --------------- | ------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `driver_enter_absence` for this rule type.                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
A rule that triggers on driver change automatically by the key or manually in widget with driver from a [drivers list](../../../field-service/employee/README.md).

#### Parameters

| name          | description                                                                                              | type                            |
| ------------- | -------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `driver_change` for this rule type.                                                                      | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                    | type                            |
| --------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `driver_distraction` for this rule type.                                                                       | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                               | type                            |
| ------------- | ----------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `g_sensor` for this rule type.                                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                           | type                            |
| --------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `fatigue_driving` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                     | type                            |
| --------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `driver_identification` for this rule type.                                                                     | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                                                      | type                            |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type          | `no_movement` for this rule type.                                                                                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                    | type                            |
| ------------- | ------------------------------------------------------------------------------ | ------------------------------- |
| type          | `sos` for this rule type.                                                      | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                | type                            |
| --------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `proximity_violation` for this rule type.                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                 | type                            |
| ------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `parking` for this rule type.                                                                               | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                             | type                            |
| ------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `backup_battery_low` for this rule type.                                                                | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                            | type                            |
| --------------- | -------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `bracelet` for this rule type.                                                         | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                     | type                            |
| ------------- | ----------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `call_button_pressed` for this rule type.                                                       | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                             | type                            |
| ------------- | --------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `alarmcontrol` for this rule type.                                                      | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                          | type                            |
| ------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `case_intrusion` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                        | type                            |
| ------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type          | `check_engine_light` for this rule type.                                                                           | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                            | type                            |
| --------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type            | `obd_plug_unplug` for this rule type.                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                 | type                            |
| ------------- | ------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `door_alarm` for this rule type.                                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                                    | type                            |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| type            | `external_device_connection` for this rule type.                                                                               | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                    | type                            |
| --------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `battery_off` for this rule type.                                                              | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                            | type                            |
| ------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `antenna_disconnect` for this rule type.                                                                               | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                    | type                            |
| ------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `gps_damp` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                             | type                            |
| --------------- | --------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `gps_lost_recover` for this rule type.                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                    | type                            |
| ------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `gsm_damp` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                 | type                            |
| ------------- | ------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `hood_alarm` for this rule type.                                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                    | type                            |
| ------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `ignition` for this rule type.                                                                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                    | type                            |
| --------------- | ---------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `light_sensor` for this rule type.                                                             | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                          | type                            |
| ------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `location_response` for this rule type.                                                                              | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                     | type                            |
| --------------- | ------------------------------------------------------------------------------- | ------------------------------- |
| type            | `locking_unlocking` for this rule type.                                         | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                     | type                            |
| ------------- | ----------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `lowpower` for this rule type.                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                       | type                            |
| --------------- | ------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `strap_bolt` for this rule type.                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                             | type                            |
| ------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `detach` for this rule type.                                                                            | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                           | type                            |
| --------------- | ------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `on_off` for this rule type.                                                          | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                                    | type                            |
| --------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `offline` for this rule type.                                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                          | type                            |
| ------------- | ------------------------------------------------------------------------------------ | ------------------------------- |
| type          | `poweron` for this rule type.                                                        | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                              | type                            |
| --------------- | ---------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `vibration` for this rule type.                                                          | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                           | type                            |
| --------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `input_change` for this rule type. Both events for switch on/off will have `input_change` event type. | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                             | type                            |
| --------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `output_change` for this rule type. Both events for switch on/off will have `output_change` event type. | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name            | description                                                                                         | type                            |
| --------------- | --------------------------------------------------------------------------------------------------- | ------------------------------- |
| type            | `sensor_range` for this rule type.                                                                  | [enum](../../../../../general/api-conventions.md#data-types) |
...
| name          | description                                                                                                     | type                            |
| ------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| type          | `state_field_control` for this rule type.                                                                       | [enum](../../../../../general/api-conventions.md#data-types) |
...
| `state_field`           | State field code. Only specified if `virtual_sensor_id` and `tracker_params` are not specified.                 | [enum](../../../../../general/api-conventions.md#data-types) |
...
| `state_field`        | State field code. Only specified if `virtual_sensor_id` is not specified.                        | [enum](../../../../../general/api-conventions.md#data-types) |
