---
title: Sensor inputs
description: Every sensor input and state field the Navixy platform knows, with its description.
---

# Sensor inputs

This operation returns every sensor input and state field the platform recognises, each with a human-readable description. It is the lookup table behind the raw identifiers that appear everywhere else: the `input_name` on a [sensor](README.md), and the keys in the `inputs` and `states` objects that [`tracker/get_readings`](../README.md#post-tracker-get_readings), [`tracker/get_fuel`](../README.md#post-tracker-get_fuel), and [`tracker/get_diagnostics`](../README.md#post-tracker-get_diagnostics) return.

Descriptions come back in the account's language, following its [locale settings](../../../commons/user/settings/README.md).

## API actions

API base path: `/tracker/sensor/input_name`.

This call returns the [general error codes](../../../../../general/errors.md#error-codes) only.

{% openapi-operation spec="navixy-platform" path="/tracker/sensor/input_name/list" method="post" %}
