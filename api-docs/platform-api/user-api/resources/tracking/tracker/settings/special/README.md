---
title: Special
description: Model-specific settings that only some device models expose, each with its own object shape.
---

# Special

Some device models expose a kind of control that others do not: an electronic lock, a panic button, a power-off key. Which one, if any, a model has is reported by the `special_control` field of its [model](../../README.md#post-tracker-list_models). A value of `none` means the model has no such control.

When a model does have one, `special_control` names the settings `type` that goes with it, such as `pwr_off_key` or `sos_key`. That type is what decides the shape of the settings object, and every shape is catalogued in [Settings object structures by type](#settings-object-structures-by-type) below.

Three operations act on a model's special control:

* Read its settings with [`tracker/settings/special/read`](#post-tracker-settings-special-read).
* Change them with [`tracker/settings/special/update`](#post-tracker-settings-special-update).
* Perform the control itself with [`tracker/send_command`](../../#post-tracker-send_command), whose `special_settings` parameter takes the same object.
...
{% openapi-operation spec="navixy-platform" path="/tracker/settings/special/read" method="post" %}
...
{% openapi-operation spec="navixy-platform" path="/tracker/settings/special/update" method="post" %}
[OpenAPI navixy-platform](../../../../../reference/Navixy_Platform.json)
{% endopenapi-operation %}
...
* `low_battery_mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `enable` | `disable`.
* `ext_input_mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `enable` | `disable`.
* `sos_button_mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `enable` | `disable`.
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `enable` | `disable`.
...
* `function` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `slot1` | `slot2` | `vu_activities` | `vu_no_activities`
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `on_need` | `ign_on_only` | `ign_on` | `low_charge`.
...
* `fuel_type` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `gasoline` | `diesel` | `lpg`.
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `disable` | `gps_only` | `motion_sensor_only` | `gps_and_motion_sensor`.
* `high_speed` - int. Can be 100 - 400.
* `high_speed_braking_delta` - int. Can be 0 - 100.
* `high_speed_acceleration_delta` - int. Can be 0 - 100.
* `medium_speed` - int. Can be 60 - 100.
...
* `sensitivity` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `easy` | `normal` | `hard` | `hardest`.
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `power_voltage` | `din1` | `movement`.
...
* `function` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `bt_disable` | `bt_enable` | `bt_clear` | `bt_write`.
* `bt_state` - boolean.
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `report` | `call_report`.
...
* `data_type` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `overview` | `activities` | "eventsAndFaults" | "detailedSpeed" | "technicalData" | "card1Download" | "card2Download".
...
* `mode` - [enum](../../../../../../general/api-conventions.md#data-types). Can be `disabled` | `power_voltage` | `motion_sensor`.
