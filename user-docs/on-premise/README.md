---
description: >-
  Access guides for Navixy on-premise installation, configuration, maintenance,
  and upgrades. Compare on-premise and PaaS options in the Q&A section.
---
...
Discover a comprehensive guide that simplifies the [installation](overview/how-to-guide/installation/), [upgrades](qa/software-updates/), [configuration](overview/how-to-guide/configuration/) and [maintenance](overview/how-to-guide/maintenance/) of Navixy infrastructure on your own premises. Gain valuable insights to determine the most suitable infrastructure for your specific needs. Make use of this all-inclusive resource to enhance installation quality, streamline upgrades, and ensure optimal maintenance.
