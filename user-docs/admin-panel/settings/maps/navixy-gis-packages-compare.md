...
Navixy is compatible with nearly all geographic information services (GIS). If needed, Navixy can also integrate it with a customer's specific GIS.

Navixy offers two GIS packages: **Basic GIS** and **Premium GIS**.
...
[Contact the Navixy team](https://www.navixy.com/contact/) to activate the chosen GIS Package.
