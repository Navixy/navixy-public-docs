...
1. **Admin role (default):** This role has the highest level of privileges in the panel. Admin users can access all features and settings of the Navixy platform, including user management, billing, and device management. There can only be one account (the main account) with this role per one Admin Panel instance.
