...
<figure><img src="../.gitbook/assets/image (94) (1).png" alt="Users page"><figcaption><p>Users page</p></figcaption></figure>
...
To start creating a user, click <img src="../.gitbook/assets/image (75) (2).png" alt="" data-size="line">. For more information about this process, see [Creating users](create-user.md).
...
CSV and XLSX formats allow importing files into CRMs or mailing providers without any additional editing. To download the user data, click <img src="../.gitbook/assets/image (18) (1).png" alt="Download user data" data-size="line"> and select the file format. The download starts automatically, and you can use the exported data as you see fit.

<figure><img src="../.gitbook/assets/image (17) (1).png" alt="Downloading user data" width="375"><figcaption><p>Downloading user data</p></figcaption></figure>
