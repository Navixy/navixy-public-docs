...
<figure><img src=".gitbook/assets/schedule-status-dialog.png" alt="Schedule &#x26; Status dialog with the cron expression set to every 8 hours, a 5-minute timeout, and the overlap policy set to skip concurrent runs"><figcaption><p>The Schedule &#x26; Status dialog controls the cron expression, timeout, and overlap policy for a workflow.</p></figcaption></figure>
