...
All formulas in IoT Logic follow the specifications of [Navixy IoT Logic Expression Language](https://app.gitbook.com/s/tx3J5BxnWyPV0nP2xr0z/technologies/navixy-iot-logic-expression-language). Below, you find a brief reference to the two options of the language syntax. The choice of syntax depends on the particular case, and is designed for convenience:&#x20;

* Short syntax is easy to write and works best when you need only the recent data.
* Long syntax is slightly more complex, but offers more control on the data depth when you need to handle historic values.

{% hint style="success" %}
Syntax option doesn't affect the formula itself! You can also combine short and long syntax in the same formula.
{% endhint %}
