...
4. Save your changes when complete. The Navixy platform prompts you to save any unsaved changes before leaving the editing interface.
...
2. Click **Remove** next to the desired application. You are asked for confirmation of this action.
3. Once confirmed, the application is permanently deleted from both the sidebar and the **User applications** list.

{% hint style="danger" %}
Removed applications can't be recovered.
{% endhint %}
