...
To see the event history for an object, select it and click <img src="../../../.gitbook/assets/Untitled-20250414-131158 (1).png" alt="Untitled-20250415-082401.png" data-size="line">. You are prompted to select a time and date range. After choosing the desired period, proceed to the **History** window and select the **Events** tab.
{% endhint %}

{% columns fullWidth="true" %}
{% column %}
![History date range selection](<../../../.gitbook/assets/image-20240807-220921 (1).png>)
{% endcolumn %}

{% column %}
![Events list](<../../../.gitbook/assets/image-20240808-192325 (1).png>)
{% endcolumn %}
{% endcolumns %}
