...
To access the **Geofences** tool, click <img src="../../../.gitbook/assets/image-20250425-083834 (1).png" alt="image-20250425-083834.png" data-size="line"> in the upper-right corner of the map. Selecting any of the geofences displays the objects currently located within its borders.
...
Hover the cursor over the <img src="../../../.gitbook/assets/image-20250325-150554 (1).png" alt="New geofence" data-size="line"> button and select the geofence you want to create:
...
To delete a geofence, select it and click <img src="../../../.gitbook/assets/image-20250425-104605 (1).png" alt="Trash can icon" data-size="line"> in the top-right corner next to **Quick search**.
...
To see details about the selected geofence, click <img src="../../../.gitbook/assets/Untitled-20250416-090916 (1).png" alt="Information icon" data-size="line"> next to it.
...
2. Click the ![Up arrow](<../../../.gitbook/assets/image-20250425-105021 (1).png>) (**Circle geofences import)** button.
...
1. Open the **Geofences** tool.
2. Hover the cursor over the ![image-20250425-105021.png](<../../../.gitbook/assets/image-20250425-105021 (1).png>) button and click the <img src="../../../.gitbook/assets/{E5CAE5A6-4E23-4E40-BD54-AFFD76032B23} (1).png" alt="" data-size="line"> (**Geofences import from KML**) button.
...
1. Open the **Geofences** tool.
2. Click ![Down arrow icon](<../../../.gitbook/assets/image-20250425-132255 (1).png>) on the tool panel.
