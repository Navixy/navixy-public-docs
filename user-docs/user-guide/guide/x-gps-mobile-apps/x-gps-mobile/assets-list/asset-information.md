...
The asset information screen in the **Tracking** section displays detailed information about the asset, including its location on the map, trip and event history, reminders, linked units, assigned GPS device, tags, and other data. It also allows you to quickly create a [geo link](../geo-links-in-x-gps-mobile.md) for this asset.

{% columns %}
{% column %}
<figure><img src="../../../../.gitbook/assets/image (19).png" alt="Vehicle information screen in X-GPS Mobile, Tracking section"><figcaption><p>Vehicle information</p></figcaption></figure>
{% endcolumn %}

{% column %}
<figure><img src="../../../../.gitbook/assets/image (24).png" alt="Staff member information screen in X-GPS Mobile, Tracking section"><figcaption><p>Staff information</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
Tap <img src="../../../../.gitbook/assets/72b55e8f-c207-46df-bb7b-df4900c1db13" alt="icon5.png" data-size="line"> to display the map options menu, where you can select places, geofences, and map type.
