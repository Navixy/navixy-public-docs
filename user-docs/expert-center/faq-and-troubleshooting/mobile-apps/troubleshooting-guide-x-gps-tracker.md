---
description: >-
  Resolve missing points and signal loss in the X-GPS Tracker mobile app. Covers
  required permissions, battery optimization, and operating system restrictions.
---
...
If everything has been configured correctly and the problem persists, you can report the situation to [support@navixy.com](mailto:support@navixy.com) with the following information:
